...
const About = () => {
  ...
  const isSkillView = useInView(skilRef,{once:true,margin:"-50px"});

  const experienceRef = useRef();
  const isExperienceView = useInView(experienceRef,{once:true,margin:"-50px"});
  ...
  return (
    ...
    >
      ...
      <div className=" h-full overflow-scroll lg:flex" ref={containerRef}>
        ...
        <div className="p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64 lg:w-2/3 lg:pr-0 xl:1/2">
          ...
          <div className="flex flex-col gap-24  pb-64 justify-center" ref={experienceRef}>
            <motion.h1 
             ...
             transition={{ delay: 0.1 }}
            className=" font-bold text-2xl">EXPERICENCE</motion.h1>
            {/* EXPERIENCE LIST */}
            <motion.div 
             initial={{ x: "-300px" }}
             animate={isExperienceView ? { x: 0 } : {}}
        ...
        <div className="hidden lg:block w-1/3 sticky z-45 top-0 xl:w-1/3">
